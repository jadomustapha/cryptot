    ...
    ============================================================================================================================-->
        <footer class="site-footer section-spacing text-center " id="eight">
            <div class="container">
                <div class="row">
                    <div class="col-md-4">
                        <p class="footer-links"><a href="#" style="color:#000;">Terms of Use</a> <a href="#"
                                style="color:#000;">Privacy Policy</a></p>
                    </div>
                    <div class="col-md-4"> <small style="color:#000;">&copy; 2022 Crypto Technology Center
                            reserved.</small></div>
                    <div class="col-md-4">
                        <!--social-->
                        <ul class="social">
                            ...
                            <li><a href="https://youtu.be/of3hzZZ1Mxc" target="_blank"><i
